...
// AVSResponseCode represents the valid avs resposne codes for street address and zip code that can be present in a firstdata response
...
// Response contains all of the fields for all firstdata API call responses
